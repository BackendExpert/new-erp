...
const SummaryDash = () => {
  ...
  const DataList = [
    ...
    {id: 26, name:"Research Assistants" , value: <CountUp end={CountHODSRN}/>, icons: <Icons name="school" size="large"/>, style:"hover:border-blue-500 hover:text-blue-600" },  
  ]
        ...
        <div className="lg:grid grid-cols-3 gap-5">
      {
        DataList.map((data, index) => {
            ...
            if(RoleUser === "SuperAdmin"){
              if(data.id !== 13 && data.id !== 14 && data.id !== 15 && data.id !== 16 && data.id !== 17 && data.id !== 18 && data.id !== 19 && data.id !== 20 && data.id !== 21 && data.id !== 22 && data.id !== 23 && data.id !== 24 && data.id !== 25 && data.id !== 26){
                return (           

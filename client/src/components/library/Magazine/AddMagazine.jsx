            ...
            <div className="bg-gray-200 py-4">
                ...
                <div className="my-2">
                    <form onSubmit={headleSubmit}>
                        ...
                        <div className="">
                            <button type="submit" className="rounded text-green-500 border border-green-500 py-4 px-16 my-2 duration-500 hover:bg-green-500 hover:text-white hover:shadow-xl">Add Magazine</button>
                        </div>

              ...
              <form onSubmit={headleUpdate}>
                <div className="lg:grid grid-cols-2 gap-2">
                    <div className="my-2">
                      ...
                      value={updateProject.divno} onChange={e => SetupdateProject({...updateProject, divno:e.target.value})}/>
                    </div>
                    ...
                    <div className="my-2">
                      ...
                      value={updateProject.hod} onChange={e => SetupdateProject({...updateProject, hod:e.target.value})}/>
                    </div>
                </div>
                <div className="lg:grid grid-cols-2 gap-2">
                  <div className="my-2">
                      ...
                      value={updateProject.ra1} onChange={e => SetupdateProject({...updateProject, ra1:e.target.value})}/>
                  </div>
                  <div className="my-2">
                      ...
                      value={updateProject.ra2} onChange={e => SetupdateProject({...updateProject, ra2:e.target.value})}/>
                  </div>
                </div>
                <div className="">

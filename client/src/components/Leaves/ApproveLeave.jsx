        ...
        return (
            <div className="bg-gray-200 py-4">
                <div className="bg-white my-2 mx-8 py-6 shadow-xl rounded border-b-4 border-blue-400 px-4">
                    ...
                    <div className="lg:flex pl-2 my-4">
                        <button onClick={() => HeadleButtonClick('Recommend')} className="my-2 ml-2 py-2 px-4 border border-yellow-500 text-yellow-500 rounded duration-500 hover:bg-yellow-500 hover:text-white hover:shadow-xl">Recommend Leaves</button>
                        <button onClick={() => HeadleButtonClick('Reject')} className="my-2 ml-2 py-2 px-4 border border-red-500 text-red-500 rounded duration-500 hover:bg-red-500 hover:text-white hover:shadow-xl">Reject Leaves</button>
                        <button onClick={() => HeadleButtonClick('Approve')} className="my-2 ml-2 py-2 px-4 border border-green-500 text-green-500 rounded duration-500 hover:bg-green-500 hover:text-white hover:shadow-xl">Approve Leaves</button>
                    </div>
